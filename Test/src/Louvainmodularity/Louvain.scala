...
class Louvain() extends Serializable{
  ...
  def run[VD: ClassTag](sc: SparkContext, config: LouvainConfig): Array[Graph[LouvainData, Long]] = {
    ...
    var list: Array[Graph[LouvainData, Long]] = Array()
    do {
      compressionLevel += 1
